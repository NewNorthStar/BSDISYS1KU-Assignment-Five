...
var file_grpc_pb_proto_rawDesc = []byte{
	...
	0x50, 0x52, 0x4f, 0x47, 0x52, 0x45, 0x53, 0x53, 0x10, 0x04, 0x32, 0x84, 0x01, 0x0a, 0x0e, 0x41,
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x14, 0x0a,
	...
	0x06, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x04, 0x2e, 0x4c, 0x6f, 0x74, 0x12, 0x22, 0x0a,
	0x0c, 0x47, 0x65, 0x74, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x12, 0x06, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0a, 0x2e, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72,
...
var file_grpc_pb_proto_depIdxs = []int32{
	...
	2, // 1: AuctionService.PutBid:input_type -> Bid
	5, // 2: AuctionService.GetAuctionStatus:input_type -> Empty
	5, // 3: AuctionService.GetLot:input_type -> Empty
	5, // 4: AuctionService.GetDiscovery:input_type -> Empty
	3, // 5: AuctionService.PutBid:output_type -> Ack
	3, // 6: AuctionService.GetAuctionStatus:output_type -> Ack
	1, // 7: AuctionService.GetLot:output_type -> Lot
	4, // 8: AuctionService.GetDiscovery:output_type -> Discovery
